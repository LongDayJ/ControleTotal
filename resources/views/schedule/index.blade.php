    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="btn-group mb-3" role="group" aria-label="Calendar Actions">
          <button id="exportButton" class="btn btn-success">{{__('Export Calendario')}}</button>
        </div>
        <div class="btn-group mb-3" role="group" aria-label="Calendar Actions">
          <button id = "openModal" class="btn btn-success" data-toggle = "modal" data-target="#eventModal">{{__('Adicionar')}}</b>
        </div>
      </div>
      <div class="card">
        <div class="card-body">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="eventForm" action="{{ URL('/create-schedule') }}" method="POST">
      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventContent: function(info) {
          ...
          eventElement.querySelector('span').addEventListener('click', function() {
            if (confirm("Você está certo em querer deletar este agendamento?")) {
              ...
              $.ajax({
                ...
                error: function(error) {
                  console.log('Erro deletando evento', error);
                }
              });
            }
          });
