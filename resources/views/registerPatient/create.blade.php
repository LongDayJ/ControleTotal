<x-appBarAdmin title="Cadastro de Colaborador">
	...
	<div class="container pt-3">
		...
		<div class="row justify-content-center align-items-center align-content-center d-flex pb-5">
			<div class="col-8">
				<form id="formStep1" action="{{ route('registerPatient.store') }}" method="POST">
					@csrf
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-6 mb-3">
							<label for="numeroCasa" class="form-label">Nº do endereço: <span class="text-danger">*</span></label>
